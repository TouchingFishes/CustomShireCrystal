...
DEF HOENN_POKEMON EQU const_value
	...
	const HARIYAMA   ; 126
	const DUSCORN    ; 127
	const FLETCHLING ; 128
	const FLETCHINDA ; 129
	const TALONFLAME ; 12a
	const SKITTY     ; 12b
	const DELCATTY   ; 12c
	const TROPIUS    ; 12b
	const TANGROWTH  ; 12c
	...
	const LATIAS     ; 17a
	const LATIOS     ; 17b
	const KYOGRE     ; 17c hoopa
	const GROUDON    ; 17d meloetta
	const RAYQUAZA   ; 18e marshadow
	const JIRACHI    ; 18f
