...
; FruitTreeItems indexes (see data/items/fruit_trees.asm)
	...
	const FRUITTREE_VIRIDIAN_FOREST ; 19
...
; MoveTutor setval arguments
	...
	const MOVETUTOR_FRENZY_PLANT ; 4
	const MOVETUTOR_BLAST_BURN   ; 5
	const MOVETUTOR_HYDRO_CANNON ; 6
	const MOVETUTOR_FOCUS_PUNCH  ; 7
	const MOVETUTOR_MEGA_PUNCH   ; 8
	const MOVETUTOR_MEGA_KICK    ; 9
	const MOVETUTOR_SOFTBOILED   ; a