...
; Johto hidden items
	...
	const EVENT_ILEX_FOREST_HIDDEN_ELIXER
	...
	const EVENT_ICE_PATH_B2F_MAHOGANY_SIDE_HIDDEN_BLIZZARD
	...
	const EVENT_ROUTE_28_HIDDEN_HYPER_BEAM
...
; Kanto hidden items
	...
	const EVENT_VIRIDIAN_FOREST_HIDDEN_RARE_CANDY
...
; Guitarist
	const EVENT_BEAT_GUITARIST_LYDIA
	const EVENT_BEAT_GUITARIST_MOA
	const EVENT_BEAT_GUITARIST_SUZU
; Juggler
	...
	const EVENT_BEAT_JUGGLER_NELSON
; Gentleman
...
; Blackbelt
	...
	const EVENT_BEAT_BLACKBELT_DAI
; Beauty
...
; Kimono Girl
	const EVENT_BEAT_KIMONO_GIRL_NATSUMI
...
; Pokemaniac
	...
	const EVENT_BEAT_POKEMANIAC_VINCE
; GruntM
...
; AceTrainerM
	const EVENT_BEAT_ACE_TRAINERM_NICK
	const EVENT_BEAT_ACE_TRAINERM_AARON
	const EVENT_BEAT_ACE_TRAINERM_PAUL
	const EVENT_BEAT_ACE_TRAINERM_CODY
	const EVENT_BEAT_ACE_TRAINERM_MIKE ;unused
	const EVENT_BEAT_ACE_TRAINERM_GAVEN2
	const EVENT_BEAT_ACE_TRAINERM_GAVEN3
	const EVENT_BEAT_ACE_TRAINERM_RYAN
	const EVENT_BEAT_ACE_TRAINERM_JAKE
	const EVENT_BEAT_ACE_TRAINERM_GAVEN
	const EVENT_BEAT_ACE_TRAINERM_BLAKE
	const EVENT_BEAT_ACE_TRAINERM_BRIAN
	const EVENT_BEAT_ACE_TRAINERM_ERICK
	const EVENT_BEAT_ACE_TRAINERM_ANDY
	const EVENT_BEAT_ACE_TRAINERM_TERRY
	const EVENT_BEAT_ACE_TRAINERM_SEAN
	const EVENT_BEAT_ACE_TRAINERM_KEVIN
	const EVENT_BEAT_ACE_TRAINERM_STEVE
	const EVENT_BEAT_ACE_TRAINERM_ALLEN
	const EVENT_BEAT_ACE_TRAINERM_COLBY
; AceTrainerF
	const EVENT_BEAT_ACE_TRAINERF_GWEN
	const EVENT_BEAT_ACE_TRAINERF_LOIS
	const EVENT_BEAT_ACE_TRAINERF_FRAN
	const EVENT_BEAT_ACE_TRAINERF_LOLA
	const EVENT_BEAT_ACE_TRAINERF_KATE
	const EVENT_BEAT_ACE_TRAINERF_IRENE
	const EVENT_BEAT_ACE_TRAINERF_KELLY
	const EVENT_BEAT_ACE_TRAINERF_JOYCE
	const EVENT_BEAT_ACE_TRAINERF_BETH
	const EVENT_BEAT_ACE_TRAINERF_REENA
	const EVENT_BEAT_ACE_TRAINERF_MEGAN
	const EVENT_BEAT_ACE_TRAINERF_BETH2
	const EVENT_BEAT_ACE_TRAINERF_CAROL
	const EVENT_BEAT_ACE_TRAINERF_QUINN
	const EVENT_BEAT_ACE_TRAINERF_EMMA
	const EVENT_BEAT_ACE_TRAINERF_CYBIL
	const EVENT_BEAT_ACE_TRAINERF_JENN
	const EVENT_BEAT_ACE_TRAINERF_BETH3
	const EVENT_BEAT_ACE_TRAINERF_REENA2
	const EVENT_BEAT_ACE_TRAINERF_REENA3
	const EVENT_BEAT_ACE_TRAINERF_NAOMI
	const EVENT_BEAT_ACE_TRAINERF_ALEXA
; ExecutiveF
...
; Crystal-exclusive trainer flags
	const EVENT_BEAT_ACE_TRAINERM_DARIN
	const EVENT_BEAT_ACE_TRAINERF_CARA
...
; Newly added trainers (84 unused events left)
; Bato	
	const EVENT_BEAT_BATO
; Steven
	const EVENT_BEAT_STEVEN
	const EVENT_BEAT_STEVEN_AGAIN
; Agatha
	const EVENT_BEAT_AGATHA
; Lorelei
	const EVENT_BEAT_LORELEI
; Hex Maniac
	const EVENT_BEAT_HEX_MANIAC_TASHA
	const EVENT_BEAT_HEX_MANIAC_LILI
	const EVENT_BEAT_HEX_MANIAC_MALIA
	const EVENT_BEAT_HEX_MANIAC_PEGGY
; Veteran F
	const EVENT_BEAT_VETERAN_F_MONICA
	const EVENT_BEAT_VETERAN_F_LENORE
	const EVENT_BEAT_VETERAN_F_FILJA
	const EVENT_BEAT_VETERAN_F_JULIE
; Veteran M
	const EVENT_BEAT_VETERAN_M_CONNOR
	const EVENT_BEAT_VETERAN_M_YURI
	const EVENT_BEAT_VETERAN_M_LEON
	const EVENT_BEAT_VETERAN_M_RAYNOR
	const EVENT_BEAT_VETERAN_M_MORIMOTO
; Bug Maniac
	const EVENT_BEAT_BUG_MANIAC_FRED
	const EVENT_BEAT_BUG_MANIAC_ARTHUR
	const EVENT_BEAT_BUG_MANIAC_LARSON
	const EVENT_BEAT_BUG_MANIAC_WEEVIL
; Gideon
	const EVENT_BEAT_GIDEON
; Dragon Tamer
	const EVENT_BEAT_DRAGON_TAMER_KEEGAN
	const EVENT_BEAT_DRAGON_TAMER_KARL
	const EVENT_BEAT_DRAGON_TAMER_OZ
	const EVENT_BEAT_DRAGON_TAMER_JEB
	const EVENT_BEAT_DRAGON_TAMER_ZED
; Lady
	const EVENT_BEAT_LADY_SARAH
	const EVENT_BEAT_LADY_ELENORE
	const EVENT_BEAT_LADY_PRISCILLA
; Rich Boy
	const EVENT_BEAT_RICH_BOY_WINSTON
	const EVENT_BEAT_RICH_BOY_DARREN
	const EVENT_BEAT_RICH_BOY_MARCO
	const EVENT_BEAT_RICH_BOY_DAMIAN
; Engineer
	const EVENT_BEAT_ENGINEER_VINCENT
	const EVENT_BEAT_ENGINEER_BOBBY
	const EVENT_BEAT_ENGINEER_DWIGHT
	const EVENT_BEAT_ENGINEER_GABOR
; Master
	const EVENT_BEAT_MASTER_YAMA
; Alder
...
; Sora
	const EVENT_BEAT_SORA
; Moto
	const EVENT_BEAT_MOTO
; Aroma Lady
	const EVENT_BEAT_AROMA_LADY_ROSE
	const EVENT_BEAT_AROMA_LADY_DAISY
	const EVENT_BEAT_AROMA_LADY_VIOLET
	const EVENT_BEAT_AROMA_LADY_CELINA
	const EVENT_BEAT_AROMA_LADY_JENNIE
	const EVENT_BEAT_AROMA_LADY_HANA
; Ruin Maniac
	const EVENT_BEAT_RUIN_MANIAC_CHIP
	const EVENT_BEAT_RUIN_MANIAC_DUSTY
	const EVENT_BEAT_RUIN_MANIAC_FOSTER
	const EVENT_BEAT_RUIN_MANIAC_ANDRES
	const EVENT_BEAT_RUIN_MANIAC_HUNTER
; Collector
	const EVENT_BEAT_COLLECTOR_EDWIN
	const EVENT_BEAT_COLLECTOR_HECTOR
	const EVENT_BEAT_COLLECTOR_COLEMAN
	const EVENT_BEAT_COLLECTOR_BRADY
	const EVENT_BEAT_COLLECTOR_JAMAL
	const EVENT_BEAT_COLLECTOR_MINTY
; Pokeranger_F
	const EVENT_BEAT_POKERANGER_F_CATHY
	const EVENT_BEAT_POKERANGER_F_JENNA
	const EVENT_BEAT_POKERANGER_F_SOPHIA
	const EVENT_BEAT_POKERANGER_F_NORA
	const EVENT_BEAT_POKERANGER_F_ASHLEE
	const EVENT_BEAT_POKERANGER_F_KRISTA
; Pokeranger_F
	const EVENT_BEAT_POKERANGER_M_CARLOS
	const EVENT_BEAT_POKERANGER_M_GAV
	const EVENT_BEAT_POKERANGER_M_LOGAN
	const EVENT_BEAT_POKERANGER_M_TRENTON
	const EVENT_BEAT_POKERANGER_M_KYLER
	const EVENT_BEAT_POKERANGER_M_ALAIN
...
; Johto itemballs
	...
	const EVENT_LAKE_OF_RAGE_FIRE_STONE
	const EVENT_LAKE_OF_RAGE_TM_FACADE
	...
	const EVENT_BURNED_TOWER_B1F_TM_ROCK_TOMB
	const EVENT_NATIONAL_PARK_HIDDEN_CARBOS
	...
	const EVENT_OLIVINE_LIGHTHOUSE_5F_TM_SHOCK_WAVE
	...
	const EVENT_DARK_CAVE_BLACKTHORN_ENTRANCE_TM_HAIL
	...
	const EVENT_ROUTE_35_TM_BULLET_SEED
	...
	const EVENT_ROUTE_44_TM_FACADE
...
; Johto people
	...
	const EVENT_STEVEN_IN_ELMS_LAB
...
; Kanto itemballs
	...
	const EVENT_VIRIDIAN_FOREST_DIRE_HIT
	const EVENT_VIRIDIAN_FOREST_MAX_POTION
...
; New to Crystal
	...
	const EVENT_RUINS_OF_ALPH_OUTSIDE_TOURIST_FAT_GUY
	...
	const EVENT_PICKED_UP_STARDUST_FROM_AERODACTYL_ITEM_ROOM
	...
	const EVENT_ROUTE_44_MAX_REPEL ;unused
	...
	const EVENT_GOT_NATIONAL_PARK_GIFT_VANILLITE
	const EVENT_GOT_OLIVINE_CITY_GIFT_TROPIUS
	const EVENT_LANCE_SEEKS_BALANCE
	const EVENT_RUINS_OF_ALPH_OUTSIDE_GOT_OMANYTE
	const EVENT_RUINS_OF_ALPH_OUTSIDE_GOT_KABUTO
	const EVENT_RUINS_OF_ALPH_OUTSIDE_GOT_LILEEP
	const EVENT_RUINS_OF_ALPH_OUTSIDE_GOT_ANORITH
