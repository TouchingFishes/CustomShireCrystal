...
MortyGroup:
	...
	db 24
	dw DUSKULL
	dw DISABLE, SHADOW_BALL, CONFUSE_RAY, FAINT_ATTACK
	db 27
	dw GENGAR
...
JasmineGroup:
	...
	db 34
	dw DECIBELLE
	dw PROTECT, SWIFT, MIRROR_SHOT, PSYWAVE
	db 34
	dw MAGNETON
	...
	db 50
	dw DECIBELLE
	dw SHOCK_WAVE, SWIFT, SHADOW_BALL, PSYCHIC_M
	db 50
	dw MAGNEZONE
	dw THUNDERBOLT, SUPERSONIC, MIRROR_SHOT, THUNDER_WAVE
	db 53
...
ClairGroup:
	...
	db 54
	dw CHARIZARD
	dw FLAMETHROWER, EARTHQUAKE, FLY, DRAGON_CLAW
	db 51
	dw DRAGONAIR
	...
	db 73
	dw CHARIZARD
	dw FIRE_BLAST, EARTHQUAKE, FLY, DRAGON_CLAW
	db 72
	dw DUNDRAG
...
KogaGroup:
	...
	dw GLISCOR
	dw NO_ITEM
	dw QUICK_ATTACK, TOXIC, FAINT_ATTACK, EARTHQUAKE
	db 50 ;42
	dw MUK
	dw NO_ITEM
...
ChampionGroup:
	...
	dw CHARIZARD
	dw NO_ITEM
	dw TWISTER, BLAST_BURN, EARTHQUAKE, DRAGON_CLAW 
	db 75 
	dw EELEKTROSS
	dw NO_ITEM
	dw THUNDERBOLT, DRAGON_CLAW, FLAMETHROWER, HYPER_BEAM
...
LassGroup:
	...
	db 19
	dw ODDISH
	dw ABSORB, POISONPOWDER, SLEEP_POWDER, STUN_SPORE
	db 21
	dw PSYDUCK
...
FisherGroup:
	...
	db 38 ;new mon
	dw SEAKING
	dw FURY_ATTACK, PSYBEAM, AURORA_BEAM, SURF
	db 38 ;new mon
	dw OCTILLERY
	...
	db 40 ;new mon
	dw KINGLER
	dw MUD_SHOT, CUT, GUILLOTINE, STRENGTH
	db 41 ;32
	dw CLOYSTER
...
BlaineGroup:
	...
	db 66
	dw CHARIZARD
	dw DRAGON_CLAW, SUNNY_DAY, SOLARBEAM, FIRE_BLAST
	db 66
	dw KUJINOUGHT
...
PsychicGroup:
	...
	db 36 ;24
	dw GIRAFARIG
	dw STOMP, AGILITY, TWIN_BEAM, SHOCK_WAVE
	db 38 ;26
	dw KADABRA
...
SoraGroup:
	...
	db 74
	dw PENDRAGON
	dw IRON_TAIL, DIG, POISON_TAIL, AERIAL_ACE
	db 76
	dw ZAPDOS
	dw THUNDERBOLT, EXTRASENSORY, DRILL_PECK, AGILITY
	db -1 ; end
