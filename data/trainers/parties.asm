...
AceTrainerMGroup:
	...
	db 47 ;new mon
	dw TAUROS
	dw DOUBLE_EDGE, AERIAL_ACE, RAGE, PURSUIT
	db 46 ;35
	dw GOLDUCK
...
MysticalmanGroup:
	...
	db 47
	dw ALTARIA
	dw EARTHQUAKE, ICE_BEAM, FLAMETHROWER, AERIAL_ACE
	db 47
	dw ELECTRODE
	dw CHARGE_BEAM, LIGHT_SCREEN, THUNDER, ROLLOUT
	db 47
	dw HERACROSS
	dw MEGAHORN, ROCK_SLIDE, COUNTER, DIG
	db 47
	dw ESPEON
	...
	db 67
	dw HERACROSS
	dw MEGAHORN, ROCK_SLIDE, BRICK_BREAK, EARTHQUAKE
	db 67
	dw ESPEON
...
VeteranFGroup:
	...
	db 64
	dw RAPIDASH
	dw FIRE_BLAST, DOUBLE_KICK, BOUNCE, IRON_TAIL
	db 64
	dw GLACEON
	dw BLIZZARD, SHADOW_BALL, WATER_PULSE, MIRROR_COAT
	db 64
	dw ARMALDO
	dw X_SCISSOR, AERIAL_ACE, METAL_CLAW, DIG
	db 64
	dw CRADILY
	dw RECOVER, CURSE, ANCIENTPOWER, SLUDGE_BOMB
	db 64
	dw LANTURN
	dw SURF, REST, THUNDERBOLT, SLEEP_TALK
	db 64
	dw DECIBELLE
	dw PSYCHIC_M, CALM_MIND, ICY_WIND, SHOCK_WAVE
	db -1 ; end
