...
MapGroup_Dungeons:
	...
	map ChallengersCaveB1F, TILESET_CAVE, CAVE, LANDMARK_DIGLETTS_CAVE, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map ViridianForest, TILESET_FOREST, CAVE, LANDMARK_ROUTE_2, MUSIC_UNION_CAVE, FALSE, PALETTE_NITE, FISHGROUP_POND
...
MapGroup_Ecruteak:
	...
	map MoveDeletersHouse, TILESET_HOUSE, INDOOR, LANDMARK_ECRUTEAK_CITY, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Blackthorn:
	...
	map ThunderWaveHouse, TILESET_HOUSE, INDOOR, LANDMARK_BLACKTHORN_CITY, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Silver:
	...
	map Route28KiwameHouse, TILESET_HOUSE, INDOOR, LANDMARK_ROUTE_28, MUSIC_SPROUT_TOWER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Cherrygrove:
	...
	map CherrygroveBay, TILESET_JOHTO, ROUTE, LANDMARK_CHERRYGROVE_CITY, MUSIC_ROUTE_30, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map SteelWingHouse, TILESET_HOUSE, INDOOR, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
