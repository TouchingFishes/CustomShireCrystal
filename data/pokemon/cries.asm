...
;Hoenn
	mon_cry CRY_BULBASAUR,   238,  129 ; TREECKO
	mon_cry CRY_BULBASAUR,   238,  129 ; GROVYLE
	mon_cry CRY_BULBASAUR,   238,  129 ; SCEPTILE
	mon_cry CRY_BULBASAUR,   238,  129 ; TORCHIC
	mon_cry CRY_BULBASAUR,   238,  129 ; COMBUSKEN
	mon_cry CRY_BULBASAUR,   238,  129 ; BLAZIKEN
	mon_cry CRY_BULBASAUR,   238,  129 ; MUDKIP
	mon_cry CRY_BULBASAUR,   238,  129 ; MARSHTOMP
	mon_cry CRY_BULBASAUR,   238,  129 ; SWAMPERT
	mon_cry CRY_GROWLITHE,   -34,  256 ; EUXINOS
	...
	mon_cry CRY_SPEAROW,       0,  256 ; VOLTREAN
	mon_cry CRY_BULBASAUR,   238,  129 ; SOLOSIS
	mon_cry CRY_BULBASAUR,   238,  129 ; DUOSION
	mon_cry CRY_BULBASAUR,   238,  129 ; REUNICLUS
	...
	mon_cry CRY_BULBASAUR,   238,  129 ; SLAKOTH
	mon_cry CRY_BULBASAUR,   238,  129 ; VIGOROTH
	mon_cry CRY_BULBASAUR,   238,  129 ; SLAKING
	mon_cry CRY_BULBASAUR,   238,  129 ; NINCADA
	mon_cry CRY_BULBASAUR,   238,  129 ; NINJASK
	mon_cry CRY_BULBASAUR,   238,  129 ; SHEDINJA
	mon_cry CRY_BULBASAUR,   238,  129 ; TINKATINK
	mon_cry CRY_BULBASAUR,   238,  129 ; TINKATUFF
	...
	mon_cry CRY_VOLTORB,       0,  272 ; SPIRITOMB
	...
	mon_cry CRY_PIDGEY,     -223,  383 ; GEKOPON
	mon_cry CRY_BULBASAUR,   238,  129 ; TYNAMO
	mon_cry CRY_BULBASAUR,   238,  129 ; EELEKTRIK
	mon_cry CRY_BULBASAUR,   238,  129 ; EELEKTROSS
	mon_cry CRY_MAGCARGO,    161,  232 ; CORSOREEF
	mon_cry CRY_DUNSPARCE,   257,  256 ; DUNDRAG
	...
	mon_cry CRY_NIDOQUEEN,   143,  144 ; VANILLITE
	mon_cry CRY_NIDOQUEEN,   119,  192 ; VANILLISH
	mon_cry CRY_BULBASAUR,   238,  129 ; VANILLUXE
	mon_cry CRY_CATERPIE,      0,  256 ; TRAPINCH
	mon_cry CRY_CATERPIE,    252,  172 ; VIBRAVA
	mon_cry CRY_CATERPIE,    168,  342 ; FLYGON
	mon_cry CRY_VULPIX,      136,  176 ; NOHFACE
	...
	mon_cry CRY_KANGASKHAN,    0,   40 ; MORGREM
	mon_cry CRY_ODDISH,        0,  224 ; GRIMMSNARL
	...
	mon_cry CRY_PARAS,       238,  383 ; DECIBELLE
	...
	mon_cry CRY_BULBASAUR,   238,  129 ; TURTWIG
	mon_cry CRY_BULBASAUR,   238,  129 ; GROTLE
	mon_cry CRY_BULBASAUR,   238,  129 ; TORTERRA
	mon_cry CRY_BULBASAUR,   238,  129 ; CHIMCHAR
	mon_cry CRY_BULBASAUR,   238,  129 ; MONFERNO
	mon_cry CRY_BULBASAUR,   238,  129 ; INFERNAPE
	mon_cry CRY_BULBASAUR,   238,  129 ; PIPLUP
	mon_cry CRY_BULBASAUR,   238,  129 ; PRINPLUP
	mon_cry CRY_BULBASAUR,   238,  129 ; EMPOLEON
	mon_cry CRY_BULBASAUR,   238,  129 ; RELICANTH
	mon_cry CRY_BULBASAUR,   238,  129 ; LUVDISC
	mon_cry CRY_BULBASAUR,   238,  129 ; RAELIC
	mon_cry CRY_BULBASAUR,   238,  129 ; ROMUSHU
	mon_cry CRY_BULBASAUR,   238,  129 ; FUSANG
	...
	mon_cry CRY_BULBASAUR,   238,  129 ; GROUDON
	mon_cry CRY_BULBASAUR,   238,  129 ; RAYQUAZA
	mon_cry CRY_BULBASAUR,   238,  129 ; JIRACHI
	mon_cry CRY_BULBASAUR,   238,  129 ; DEOXYS
