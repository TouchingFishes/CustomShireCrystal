	...
	; tm/hm learnset
	tmhm HEADBUTT, WATER_PULSE, SUBSTITUTE, TOXIC, ZAP_CANNON, SLEEP_TALK, HAIL, HIDDEN_POWER, SUNNY_DAY, BLIZZARD, HYPER_BEAM, ICY_WIND, PROTECT, RAIN_DANCE, SWIFT, FRUSTRATION, IRON_TAIL, DRAGONBREATH, THUNDER, RETURN, DOUBLE_TEAM, SHOCK_WAVE, FIRE_BLAST, FACADE, REST, ATTRACT, SURF, WATERFALL, WHIRLPOOL, ICE_BEAM, THUNDERBOLT, FLAMETHROWER, DOUBLE_EDGE, CURSE
	; end
