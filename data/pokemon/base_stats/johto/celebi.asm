	...
	; tm/hm learnset
	tmhm WATER_PULSE, SUBSTITUTE, TOXIC, HIDDEN_POWER, SLEEP_TALK, SUNNY_DAY, HYPER_BEAM, PROTECT, RAIN_DANCE, GIGA_DRAIN, SWIFT, FRUSTRATION, SOLARBEAM, RETURN, PSYCHIC_M, SHADOW_BALL, DOUBLE_TEAM, SHOCK_WAVE, MUD_SLAP, SANDSTORM, AERIAL_ACE, DREAM_EATER, FACADE, REST, SKILL_SWAP, CUT, FLASH, LIGHT_SCREEN, REFLECT, DOUBLE_EDGE, CURSE
	; end
