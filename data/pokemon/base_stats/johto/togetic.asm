	...
	; tm/hm learnset
	tmhm DYNAMICPUNCH, HEADBUTT, WATER_PULSE, SUBSTITUTE, TOXIC, HIDDEN_POWER, SLEEP_TALK, SUNNY_DAY, HYPER_BEAM, LIGHT_SCREEN, PROTECT, RAIN_DANCE, SWIFT, FRUSTRATION, SOLARBEAM, RETURN, PSYCHIC_M, SHADOW_BALL, BRICK_BREAK, DOUBLE_TEAM, REFLECT, SHOCK_WAVE, MUD_SLAP, FIRE_BLAST, AERIAL_ACE, DREAM_EATER, FACADE, REST, ATTRACT, STEEL_WING, FLY, FLASH, ROCK_SMASH, FOCUS_PUNCH, FLAMETHROWER, DOUBLE_EDGE, SOFTBOILED
	; end
