	...
	; tm/hm learnset
	tmhm HEADBUTT, WATER_PULSE, SUBSTITUTE, TOXIC, ZAP_CANNON, HAIL, SLEEP_TALK, HIDDEN_POWER, SUNNY_DAY, TAUNT, BLIZZARD, HYPER_BEAM, ICY_WIND, PROTECT, RAIN_DANCE, SWIFT, FRUSTRATION, IRON_TAIL, THUNDER, RETURN, SHADOW_BALL, DOUBLE_TEAM, MUD_SLAP, SHOCK_WAVE, SANDSTORM, FIRE_BLAST, AERIAL_ACE, DREAM_EATER, FACADE, REST, ATTRACT, THIEF, FURY_CUTTER, CUT, STRENGTH, FLASH, ROCK_SMASH, ICE_BEAM, THUNDERBOLT, FLAMETHROWER, DOUBLE_EDGE, CURSE
	; end
