	object_const_def
	const BLACKTHORNCITY_POKEMANIAC1
	const BLACKTHORNCITY_POKEMANIAC2
...
BlackthornCity_MapEvents:
	...
	warp_event  9, 31, THUNDER_WAVE_HOUSE, 1
	...
	def_object_events
	object_event 18, 12, SPRITE_POKEMANIAC, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, BlackthornPokemaniacScript, EVENT_BLACKTHORN_CITY_SUPER_NERD_BLOCKS_GYM
	object_event 19, 12, SPRITE_POKEMANIAC, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, BlackthornPokemaniacScript, EVENT_BLACKTHORN_CITY_SUPER_NERD_DOES_NOT_BLOCK_GYM
