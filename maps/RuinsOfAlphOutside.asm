...
RuinsOfAlphOutside_MapEvents:
	...
	def_warp_events
	warp_event  5, 22, RUINS_OF_ALPH_HO_OH_CHAMBER, 1
	warp_event 19,  8, RUINS_OF_ALPH_KABUTO_CHAMBER, 1
	warp_event  5, 34, RUINS_OF_ALPH_OMANYTE_CHAMBER, 1
	warp_event 23, 36, RUINS_OF_ALPH_AERODACTYL_CHAMBER, 1
	warp_event 13, 16, RUINS_OF_ALPH_INNER_CHAMBER, 1
	warp_event 25, 15, RUINS_OF_ALPH_RESEARCH_CENTER, 1
	warp_event 10, 23, UNION_CAVE_B1F, 1
	warp_event 10, 31, UNION_CAVE_B1F, 2
	warp_event 11,  5, ROUTE_36_RUINS_OF_ALPH_GATE, 3
	warp_event 23, 24, ROUTE_32_RUINS_OF_ALPH_GATE, 1
	warp_event 23, 25, ROUTE_32_RUINS_OF_ALPH_GATE, 2

	def_coord_events
	coord_event 15, 16, SCENE_RUINSOFALPHOUTSIDE_GET_UNOWN_DEX, RuinsOfAlphOutsideScientistScene1
	coord_event 14, 17, SCENE_RUINSOFALPHOUTSIDE_GET_UNOWN_DEX, RuinsOfAlphOutsideScientistScene2

	def_bg_events
	bg_event 17,  8, BGEVENT_READ, RuinsOfAlphOutsideMysteryChamberSign
	bg_event 16, 18, BGEVENT_READ, RuinsOfAlphSign
	bg_event 26, 16, BGEVENT_READ, RuinsOfAlphResearchCenterSign

	def_object_events
	object_event  8, 24, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 1, TrainerPsychicNathan, -1
	object_event 15, 17, SPRITE_SCIENTIST, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, RuinsOfAlphOutsideScientistScript, EVENT_RUINS_OF_ALPH_OUTSIDE_SCIENTIST
	object_event 17, 19, SPRITE_FAT_GUY, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, RuinsOfAlphOutsideFatGuyScript, EVENT_RUINS_OF_ALPH_OUTSIDE_TOURIST_FAT_GUY
	object_event 22, 16, SPRITE_CAMPER, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, RuinsOfAlphOutsideCamper1Script, EVENT_RUINS_OF_ALPH_OUTSIDE_TOURIST_YOUNGSTERS
	object_event 21,  9, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, RuinsOfAlphOutsideYoungster2Script, EVENT_RUINS_OF_ALPH_OUTSIDE_TOURIST_YOUNGSTERS
	object_event 15, 23, SPRITE_GENTLEMAN, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, RuinsOfAlphOutsideFossilGuyScript, -1
	object_event 16, 37, SPRITE_HIKER, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_TRAINER, 1, TrainerRuinManiacFoster, -1
	object_event  6, 38, SPRITE_SUPER_NERD, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 1, TrainerCollectorEdwin, -1
	object_event  5, 16, SPRITE_HIKER, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_TRAINER, 1, TrainerRuinManiacHunter, -1
