...
RuinsOfAlphOutside_MapEvents:
	...
	warp_event 19, 24, ROUTE_32_RUINS_OF_ALPH_GATE, 1
	warp_event 19, 25, ROUTE_32_RUINS_OF_ALPH_GATE, 2
	...
	bg_event 16, 20, BGEVENT_READ, RuinsOfAlphSign
	...
	object_event 17, 21, SPRITE_FAT_GUY, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, RuinsOfAlphOutsideFatGuyScript, EVENT_RUINS_OF_ALPH_OUTSIDE_TOURIST_FAT_GUY
	object_event 20, 16, SPRITE_CAMPER, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, RuinsOfAlphOutsideCamper1Script, EVENT_RUINS_OF_ALPH_OUTSIDE_TOURIST_YOUNGSTERS
	...
	object_event 15, 24, SPRITE_GENTLEMAN, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, RuinsOfAlphOutsideFossilGuyScript, -1
