...
OlivinePortSailorAtGangwayScript:
	...
	clearevent EVENT_BEAT_ACE_TRAINERM_SEAN
	clearevent EVENT_BEAT_ACE_TRAINERF_CAROL
...
OlivinePort_MapEvents:
	...
	object_event  4, 14, SPRITE_BUG_MANIAC, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, OlivinePortFishingGuru1Script, EVENT_OLIVINE_PORT_SPRITES_BEFORE_HALL_OF_FAME
	object_event 13, 14, SPRITE_BUG_MANIAC, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, OlivinePortFishingGuru2Script, EVENT_OLIVINE_PORT_SPRITES_BEFORE_HALL_OF_FAME
