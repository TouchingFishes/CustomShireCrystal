...
MountMortar2FInsideTMAerialAce:
	itemball TM_AERIAL_ACE ; TM_DEFENSE_CURL
...
MountMortar2FInside_MapEvents:
	...
	object_event 19, 17, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, MountMortar2FInsideTMAerialAce, EVENT_MOUNT_MORTAR_2F_INSIDE_TM_AERIAL_ACE
