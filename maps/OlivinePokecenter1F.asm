...
OlivinePokecenter1FBugManiacScript:
...
OlivinePokecenter1F_MapEvents:
	...
	object_event  8,  4, SPRITE_BUG_MANIAC, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 1, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, OlivinePokecenter1FBugManiacScript, -1
