...
ViridianNicknameSpeechHouse_MapEvents:
	...
	object_event  5,  2, SPRITE_SPEAROW, SPRITEMOVEDATA_POKEMON, 2, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, Speary, -1 ;SPRITE_MOLTRES
	object_event  6,  3, SPRITE_RATTATA, SPRITEMOVEDATA_POKEMON, 2, 0, -1, -1, PAL_NPC_PURPLE, OBJECTTYPE_SCRIPT, 0, Rattey, -1 ;SPRITE_GROWLITHE
