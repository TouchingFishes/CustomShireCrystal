...
CeruleanPoliceStationHikerScript:
	jumptextfaceplayer CeruleanPoliceStationHikerText
...
CeruleanPoliceStationHikerText:
...
CeruleanPoliceStation_MapEvents:
	...
	def_object_events
	object_event  5,  1, SPRITE_HIKER, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, CeruleanPoliceStationHikerScript, -1
