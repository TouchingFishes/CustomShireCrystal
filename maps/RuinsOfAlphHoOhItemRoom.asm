...
RuinsOfAlphHoOhItemRoomStardust:
	itemball STARDUST
...
RuinsOfAlphHoOhItemRoom_MapEvents:
	...
	object_event  5,  6, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, RuinsOfAlphHoOhItemRoomStardust, EVENT_PICKED_UP_STARDUST_FROM_HO_OH_ITEM_ROOM
