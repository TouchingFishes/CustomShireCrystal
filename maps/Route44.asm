...
Route44_MapEvents:
	...
	def_object_events
	object_event 34, 17, SPRITE_FISHER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_TRAINER, 1, TrainerFisherWilton1, -1
	...
	object_event 18, 16, SPRITE_RICH_BOY, SPRITEMOVEDATA_SPINCLOCKWISE, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 5, TrainerRichBoyDarren, -1 ;SPRITEMOVEDATA_STANDING_LEFT
