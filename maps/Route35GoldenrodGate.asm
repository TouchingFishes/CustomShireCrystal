	...
	const ROUTE35GOLDENRODGATE_POKEMANIAC
...
RandyScript:
	...
	waitsfx
	givepoke SPEAROW, PLAIN_FORM, 10, NO_ITEM, TRUE, GiftSpearowName, GiftSpearowOTName
...
Route35GoldenrodGatePokemaniacScript:
	jumptextfaceplayer Route35GoldenrodGatePokemaniacText
...
Route35GoldenrodGatePokemaniacText:
...
Route35GoldenrodGate_MapEvents:
	...
	object_event  3,  2, SPRITE_POKEMANIAC, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, Route35GoldenrodGatePokemaniacScript, -1
