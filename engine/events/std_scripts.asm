...
RadioTowerRocketsScript:
	...
	;setevent EVENT_MAHOGANY_TOWN_POKEFAN_M_BLOCKS_EAST will be set after beating archer
...
InitializeEventsScript:
	...
	setevent EVENT_RUINS_OF_ALPH_OUTSIDE_TOURIST_FAT_GUY
...
AskNumber1MScript:
	...
	ifequal PHONE_ACE_TRAINERM_GAVEN, .Gaven
...
AskNumber1FScript:
	...
	ifequal PHONE_ACE_TRAINERF_BETH, .Beth
	ifequal PHONE_ACE_TRAINERF_REENA, .Reena
